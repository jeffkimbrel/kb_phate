...
from kb_phate.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_phate'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_phate.kb_phateImpl import kb_phate  # noqa @IgnorePep8
impl_kb_phate = kb_phate(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_phate'
        ...
        self.rpc_service.add(impl_kb_phate.run_kb_phate,
